...
class Example(wx.Frame):
    ...
    def InitUI(self):   
        ...
        rtb = wx.Button(pnl, label='red', pos=(20, 25))
        gtb = wx.Button(pnl, label='green', pos=(20, 60))
        btb = wx.Button(pnl, label='blue', pos=(20, 100))

        self.cpnl  = wx.Panel(pnl, pos=(150, 20), size=(110, 110))
        self.cpnl.SetBackgroundColour(self.col)

        rtb.Bind(wx.EVT_BUTTON, self.ToggleRed)
        gtb.Bind(wx.EVT_BUTTON, self.ToggleGreen)
        btb.Bind(wx.EVT_BUTTON, self.ToggleBlue)
